...
db200 <- fpc::dbscan(ResTable[[5]][ResTable[[5]]$n==200,-3], eps = 0.0007, MinPts = 5)
...
db600 <- fpc::dbscan(ResTable[[5]][ResTable[[5]]$n==600,-3], eps = 0.0001, MinPts = 5)
bout600 <- ResTable[[5]][ResTable[[5]]$n==600,][!db600$isseed,]

dbscan::kNNdistplot(ResTable[[5]][ResTable[[5]]$n==800,-3], k = 5)
abline(h = 0.0001, lty = 2)
db800 <- fpc::dbscan(ResTable[[5]][ResTable[[5]]$n==800,-3], eps = 0.0001, MinPts = 5)
...
db200 <- fpc::dbscan(ResTable[[6]][ResTable[[6]]$n==200,-3], eps = 0.0003, MinPts = 5)
aout200 <- ResTable[[6]][ResTable[[6]]$n==200,][!db200$isseed,]

dbscan::kNNdistplot(ResTable[[6]][ResTable[[6]]$n==400,-3], k = 5)
abline(h = 0.0002, lty = 2)
db400 <- fpc::dbscan(ResTable[[6]][ResTable[[6]]$n==400,-3], eps = 0.0002, MinPts = 5)
aout400 <- ResTable[[6]][ResTable[[6]]$n==400,][!db400$isseed,]

dbscan::kNNdistplot(ResTable[[6]][ResTable[[6]]$n==600,-3], k = 5)
abline(h = 0.00005, lty = 2)
db600 <- fpc::dbscan(ResTable[[6]][ResTable[[6]]$n==600,-3], eps = 0.00005, MinPts = 5)
aout600 <- ResTable[[6]][ResTable[[6]]$n==600,][!db600$isseed,]

dbscan::kNNdistplot(ResTable[[6]][ResTable[[6]]$n==800,-3], k = 5)
abline(h = 0.00009, lty = 2)
db800 <- fpc::dbscan(ResTable[[6]][ResTable[[6]]$n==800,-3], eps = 0.00009, MinPts = 5)
...
db200 <- fpc::dbscan(ResTable[[7]][ResTable[[7]]$n==200,-3], eps = 0.002, MinPts = 5)
...
abline(h = 0.0002, lty = 2)
db600 <- fpc::dbscan(ResTable[[7]][ResTable[[7]]$n==600,-3], eps = 0.0002, MinPts = 5)
gout600 <- ResTable[[7]][ResTable[[7]]$n==600,][!db600$isseed,]

dbscan::kNNdistplot(ResTable[[7]][ResTable[[7]]$n==800,-3], k = 5)
abline(h = 0.0002, lty = 2)
db800 <- fpc::dbscan(ResTable[[7]][ResTable[[7]]$n==800,-3], eps = 0.0002, MinPts = 5)
