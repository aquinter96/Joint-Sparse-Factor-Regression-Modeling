...
abline(h = 0.0001, lty = 2)
db400 <- fpc::dbscan(ResTable[[5]][ResTable[[5]]$n==400,-3], eps = 0.0001, MinPts = 5)
...
db600 <- fpc::dbscan(ResTable[[5]][ResTable[[5]]$n==600,-3], eps = 0.00004, MinPts = 5)
bout600 <- ResTable[[5]][ResTable[[5]]$n==600,][!db600$isseed,]

dbscan::kNNdistplot(ResTable[[5]][ResTable[[5]]$n==800,-3], k = 5)
abline(h = 0.00004, lty = 2)
db800 <- fpc::dbscan(ResTable[[5]][ResTable[[5]]$n==800,-3], eps = 0.00004, MinPts = 5)
...
abline(h = 0.0005, lty = 2)
db800 <- fpc::dbscan(ResTable[[7]][ResTable[[7]]$n==800,-3], eps = 0.0005, MinPts = 5)
