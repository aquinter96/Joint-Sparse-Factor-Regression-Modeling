...
db400 <- fpc::dbscan(ResTable[[6]][ResTable[[6]]$n==400,-3], eps = 0.001, MinPts = 5)
...
abline(h = 0.001, lty = 2)
db800 <- fpc::dbscan(ResTable[[6]][ResTable[[6]]$n==800,-3], eps = 0.001, MinPts = 5)
