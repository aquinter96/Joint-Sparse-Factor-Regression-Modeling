...
source(file = "~/Paper1_SIM_sims/Model1_Meta_Param.R")
source(file = "~/Paper1_SIM_sims/Model1_Matrix_Param.R")

source(file = "~/Paper1_SIM_sims/Data_Generation.R")
...
regsem_mod <- cv_regsem(lav_mod, pars_pen = "loadings", type = "alasso",  lambda.start = 0, n.lambda = 151, jump = 0.1)

})

saveRDS(list(regsem_mod, tot.time), file=paste0("regrep", datset, "n", sampsize, ".rds"))