...
less_mod <- adaptiveLasso(lav_mod, regularized = free_params, lambdas = seq(0, 15, 0.1), control = lessSEM::controlGlmnet(nCores = 25))

})

saveRDS(list(less_mod, tot.time), file=paste0("Lessrep", datset, "n", sampsize, ".rds"))