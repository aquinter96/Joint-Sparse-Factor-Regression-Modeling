...
Country.Results.B <- OverallBAlg(Country.train$X, s_seq = 1:10)
...
Country.Results <- OverallAGAlg(Country.train, Country.Results.B, m_seq = 1:15)

stopCluster(cl)

saveRDS(Country.Results, file=paste0(Country,".Results.rds"))