...
for(i in c(200, 400, 600, 800)){
  datfiles <- list.files(pattern=paste0("Model3rep.*n",i,".rds"))
...
db200 <- fpc::dbscan(ResTable[[5]][ResTable[[5]]$n==200,-3], eps = 0.0001, MinPts = 5)
...
db400 <- fpc::dbscan(ResTable[[5]][ResTable[[5]]$n==400,-3], eps = 0.00008, MinPts = 5)
bout400 <- ResTable[[5]][ResTable[[5]]$n==400,][!db400$isseed,]

dbscan::kNNdistplot(ResTable[[5]][ResTable[[5]]$n==600,-3], k = 5)
abline(h = 0.00003, lty = 2)
db600 <- fpc::dbscan(ResTable[[5]][ResTable[[5]]$n==600,-3], eps = 0.00003, MinPts = 5)
bout600 <- ResTable[[5]][ResTable[[5]]$n==600,][!db600$isseed,]

dbscan::kNNdistplot(ResTable[[5]][ResTable[[5]]$n==800,-3], k = 5)
abline(h = 0.00003, lty = 2)
db800 <- fpc::dbscan(ResTable[[5]][ResTable[[5]]$n==800,-3], eps = 0.00003, MinPts = 5)
